...
ff = input('Please input the number of sampling frequency.')
N = ff*5;
Fs = ff;
F = 50;
...
L = length(t);
S = 0.2*sin(2*pi*10*t)+0.3*sin(2*pi*40*t)+0.4*sin(2*pi*80*t);
si = 0.2*sin(2*pi*10*ti)+0.3*sin(2*pi*40*ti)+0.4*sin(2*pi*80*ti);
